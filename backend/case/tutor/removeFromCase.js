    ...
    try {
        ...
        (function () {
            ...
            if (!user) {
                ...
                /***********   Check syntax valid   ***********/
                if (Array.isArray(studentidList) && studentidList.every(function (id) {
            ...
            if (!returnObject.studentidListValid || !returnObject.caseidValid) {
                ...
                var checkStudentsInCase_1 = new Array(studentidList.length).fill(0);
                ...
                if (checkStudentsInCase_1.every((function (e) { return e; }))) {
